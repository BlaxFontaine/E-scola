 ...
 */
final class Version20200606005711 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caregivers (id INT AUTO_INCREMENT NOT NULL, details_id INT NOT NULL, child_id INT NOT NULL, child_classe_id INT NOT NULL, UNIQUE INDEX UNIQ_F02750EABB1A0722 (details_id), UNIQUE INDEX UNIQ_F02750EADD62C21B (child_id), UNIQUE INDEX UNIQ_F02750EA5E6FC585 (child_classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE caregivers ADD CONSTRAINT FK_F02750EABB1A0722 FOREIGN KEY (details_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE caregivers ADD CONSTRAINT FK_F02750EADD62C21B FOREIGN KEY (child_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE caregivers ADD CONSTRAINT FK_F02750EA5E6FC585 FOREIGN KEY (child_classe_id) REFERENCES classes (id)');
