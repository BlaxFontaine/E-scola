 ...
 */
final class Version20200606003109 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caregivers (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE caregivers_users (caregivers_id INT NOT NULL, users_id INT NOT NULL, INDEX IDX_99565A0DDD857889 (caregivers_id), INDEX IDX_99565A0D67B3B43D (users_id), PRIMARY KEY(caregivers_id, users_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
