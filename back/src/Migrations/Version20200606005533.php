 ...
 */
final class Version20200606005533 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caregivers (id INT AUTO_INCREMENT NOT NULL, child_id INT NOT NULL, classe_id INT NOT NULL, details_id INT NOT NULL, UNIQUE INDEX UNIQ_F02750EA8F5EA509 (classe_id), UNIQUE INDEX UNIQ_F02750EADD62C21B (child_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
