 ...
 */
final class Version20200606003334 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE caregivers (id INT AUTO_INCREMENT NOT NULL, child_id INT NOT NULL, classe_id INT NOT NULL, UNIQUE INDEX UNIQ_F02750EADD62C21B (child_id), UNIQUE INDEX UNIQ_F02750EA8F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE caregivers ADD CONSTRAINT FK_F02750EADD62C21B FOREIGN KEY (child_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE caregivers ADD CONSTRAINT FK_F02750EA8F5EA509 FOREIGN KEY (classe_id) REFERENCES classes (id)');
