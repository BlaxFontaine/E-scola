 ...
 */
final class Version20200606005207 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE caregivers DROP details_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE caregivers ADD details_id INT NOT NULL');
